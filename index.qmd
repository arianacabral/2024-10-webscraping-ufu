...
Neste exemplo, vamos fazer um ***web scraping*** na página da [Physionet](https://www.physionet.org/), que é uma página que contêm arquivos de bases de dados abertas, para obter os arquivos disponíveis da base de dados **MIT-BIH Arrhythmia**.
